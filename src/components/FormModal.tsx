...
const FormModal = ({ table, type, data, id, relatedData }: FormContainerProps & { relatedData?: any }) => {
  ...
  const bgColor = type === "create" ? "bg-davYellow" : type === "update" ? "bg-davSky" : "bg-davPurple";
  ...
  const Form = () => {
    ...
    return type === "delete" && id ? (
      ...
      <p className="underline bg-red-50 text-red-600" >Under development</p>
    );
  };
